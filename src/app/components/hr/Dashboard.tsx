...
const barConfig = { recrues: { label: "Recrutements", color: "var(--chart-1)" } };
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <motion.div 
            ...
            className="rounded-3xl p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden"
          >
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <motion.div 
          ...
          className="lg:col-span-2 rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none"
        >
