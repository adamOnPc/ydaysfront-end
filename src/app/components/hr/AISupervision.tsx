...
const barConfig = { queries: { label: "Requêtes", color: "var(--chart-1)" } };
const lineConfig = { accuracy: { label: "Précision (%)", color: "var(--chart-2)" } };
          ...
          <div className="w-full h-[220px]">
            <ChartContainer config={lineConfig} className="w-full h-full">
              <LineChart data={accuracyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="accuracy" stroke="var(--color-accuracy)" strokeWidth={3} dot={{ r: 4, strokeWidth: 2 }} activeDot={{ r: 6 }} />
              </LineChart>
            </ChartContainer>
          </div>
        </motion.div>
              ...
              <div 
                ...
                className={cn(
                  ...
                  isAlert 
                    ...
                    : "bg-white/50 dark:bg-slate-800/30 border-slate-100 dark:border-slate-800/50 hover:bg-white dark:hover:bg-slate-800"
                )}
              >
