    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <motion.div 
            ...
            className="rounded-3xl p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none"
          >
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <motion.div 
          ...
          className="lg:col-span-2 rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none flex flex-col"
        >
        ...
        <motion.div 
          ...
          className="rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none flex flex-col"
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Activité récente</h3>
            <button className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">Tout voir</button>
          </div>
      ...
      <motion.div 
        ...
        className="rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none"
      >
            ...
            <Dialog key={a.id}>
              <DialogTrigger asChild>
                <button className="flex flex-col items-center justify-center gap-3 py-5 px-4 rounded-2xl bg-white/50 dark:bg-slate-800/50 border border-slate-200/50 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-800 transition-all hover:shadow-md hover:-translate-y-1 group">
                  <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    {a.id === "vacation" ? <Calendar size={18} /> : 
                     a.id === "document" ? <FileText size={18} /> : 
                     a.id === "view_docs" ? <FileText size={18} /> : <AlertCircle size={18} />}
                  </div>
              ...
              <DialogContent className="sm:max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border-white/40 dark:border-slate-800/50">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Fonctionnalité rapide en cours de développement. Pour l'instant, veuillez utiliser le menu latéral.
                  </DialogDescription>
                </DialogHeader>
              </DialogContent>
            </Dialog>
