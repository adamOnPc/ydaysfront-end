    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="relative pl-4 sm:pl-8 py-4">
        ...
        <div className="space-y-10">
          {steps.map((phase, pi) => {
            const phaseDone = phase.items.every((i) => i.done);
            const isCurrentPhase = !phaseDone && steps.findIndex(s => !s.items.every(i => i.done)) === pi;
                        ...
                        <div key={ii} className="flex items-center gap-4 group">
                          ...
                          <div className="flex-1 min-w-0">
                            <span className={cn(
                              ...
                              item.done ? "text-slate-900 dark:text-white font-semibold" : 
                          ...
                          {!item.done && !item.locked && (
                            <button className="flex-shrink-0 flex items-center gap-1 text-xs px-3 py-1.5 rounded-lg font-bold bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors shadow-sm">
