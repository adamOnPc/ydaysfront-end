    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <motion.div 
            ...
            className="rounded-3xl p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none flex flex-col items-center sm:items-start text-center sm:text-left"
          >
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <motion.div 
          ...
          className="lg:col-span-3 rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none"
        >
        ...
        >
          {/* History */}
          <div className="rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none h-full flex flex-col">
