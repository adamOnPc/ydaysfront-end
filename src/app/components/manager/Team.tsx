      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <motion.div 
            ...
            className="rounded-3xl p-5 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none flex flex-col items-center sm:items-start text-center sm:text-left"
          >
