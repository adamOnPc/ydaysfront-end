      ...
      <div className="space-y-4">
        {alerts.map((alert, i) => {
          ...
          return (
            ...
            >
              <div className={cn(
                "rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-xl shadow-slate-200/50 dark:shadow-none transition-all",
                ...
                <div className="p-5 rounded-2xl bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <button className="flex-shrink-0 flex items-center justify-center px-5 py-2.5 rounded-xl text-sm font-bold bg-blue-600 hover:bg-blue-700 text-white transition-all shadow-md shadow-blue-500/25 active:scale-95 w-full sm:w-auto">
                    Planifier action
                  </button>
                </div>
              </div>
